...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView pluspem, pluspeng, detail, setting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pluspem = findViewById(R.id.pluspem);
        pluspeng = findViewById(R.id.pluspeng);
        detail = findViewById(R.id.detail);
        setting = findViewById(R.id.setting);

        pluspem.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        pluspeng.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toOutcome(view);
            }
